...
const BeanUniversalProfile beanUniversalV1 = BeanUniversalProfile(
  byStage: {
    ...
    BeanStageKey.germination: StageTargets(
      ...
      nShortGuidanceEs:
          'En arranque, el frijol no pide empujar N alto de rutina.',
      pShortGuidanceEs:
          'En arranque, el P pesa mucho más en raíces y establecimiento.',
      kShortGuidanceEs:
          'K acompaña balance inicial y vigor, pero no suele dominar al P.',
      nPlannerHintEs:
          'Si la lectura de N está corta, usar apoyo moderado y evitar exceso temprano.',
      pPlannerHintEs:
          'Favorecer banda/starter y evitar contacto con semilla cuando el P está corto.',
      kPlannerHintEs:
          'Activar K solo si el suelo viene bajo y el lote realmente lo justifica.',
      nConfidence01: 0.72,
      pConfidence01: 0.86,
      kConfidence01: 0.70,
    ),
    BeanStageKey.emergence: StageTargets(
      ...
      kWindowLabelEs: 'Soporte inicial de K',
      nShortGuidanceEs:
          'N acompaña establecimiento, pero el foco sigue sin ser un empuje fuerte.',
      pShortGuidanceEs:
          'P sigue siendo la prioridad principal al salir la planta.',
      kShortGuidanceEs: 'K acompaña vigor y balance inicial.',
      nPlannerHintEs:
          'Si N viene corto, corrige con prudencia y sin castigar nodulación futura.',
      pPlannerHintEs:
          'Si P viene corto, priorizar banda/starter y buena colocación.',
    ...
    BeanStageKey.vegEarly: StageTargets(
      ...
      nShortGuidanceEs:
          'N empieza a ganar peso, pero P sigue muy metido en arranque.',
      pShortGuidanceEs:
          'Todavía conviene cuidar P por su papel en energía y sistema radicular.',
      kShortGuidanceEs: 'K acompaña balance hídrico y vigor de crecimiento.',
      nPlannerHintEs:
          'Si el lote viene corto de N, preferir corrección moderada y bien justificada.',
      pPlannerHintEs:
          'Si P sigue corto, reforzar arranque con banda y buena colocación.',
      kPlannerHintEs:
          'Activar K si el suelo está bajo o el balance del lote se aprieta.',
      nConfidence01: 0.76,
      pConfidence01: 0.84,
      kConfidence01: 0.74,
    ),
    BeanStageKey.vegAdvanced: StageTargets(
      ...
      nShortGuidanceEs:
          'N ya sube fuerte de peso al avanzar el crecimiento del frijol.',
      pShortGuidanceEs:
          'P sigue aportando energía, pero ya no domina como en arranque.',
      kShortGuidanceEs: 'K ayuda a sostener balance y vigor del lote.',
      nPlannerHintEs:
          'Si el lote no viene bien nodulado, aquí conviene revisar cobertura real de N.',
      pPlannerHintEs:
          'Corregir P solo si la lectura sigue corta y la etapa todavía lo paga.',
      kPlannerHintEs:
          'Subir K cuando el suelo viene bajo y el lote empieza a demandar más soporte.',
      nConfidence01: 0.84,
      pConfidence01: 0.76,
      kConfidence01: 0.76,
    ),
    ...
    BeanStageKey.flowering: StageTargets(
      ...
      nShortGuidanceEs:
          'En floración, N gana mucho peso si la cobertura del lote quedó corta.',
      pShortGuidanceEs:
          'P sigue aportando energía, pero su papel más fuerte ya ocurrió al arranque.',
      kShortGuidanceEs: 'K ayuda mucho al balance fisiológico en floración.',
      nPlannerHintEs:
          'Revisar nodulación y cobertura del plan antes de meter más N.',
      pPlannerHintEs:
          'Pagar P tardío solo cuando la lectura realmente lo justifique.',
      kPlannerHintEs:
          'Si K viene bajo, aquí ya puede volverse un soporte importante.',
      nConfidence01: 0.88,
      pConfidence01: 0.74,
      kConfidence01: 0.80,
    ),
    BeanStageKey.podSet: StageTargets(
      ...
      nShortGuidanceEs:
          'En amarre de vaina, N sigue muy sensible si el lote viene corto.',
      pShortGuidanceEs:
          'P se mantiene como soporte, pero no suele ser el cuello principal aquí.',
      kShortGuidanceEs:
          'K gana peso en balance hídrico y estabilidad fisiológica.',
      nPlannerHintEs:
          'Si la lectura de N sigue apretada, revisar cobertura y nodulación con mucha atención.',
      pPlannerHintEs:
          'No empujar P de rutina en esta fase si el lote ya viene cubierto.',
      kPlannerHintEs:
          'Con K bajo, aquí sí conviene evaluar soporte del nutriente.',
      nConfidence01: 0.90,
      pConfidence01: 0.72,
      kConfidence01: 0.82,
    ),
    ...
    BeanStageKey.grainFill: StageTargets(
      ...
      nShortGuidanceEs:
          'N sigue importando en llenado, sobre todo si la nodulación no sostuvo el ritmo.',
      pShortGuidanceEs:
          'P pasa a un papel más de soporte que de empuje principal.',
      kShortGuidanceEs:
          'K se vuelve muy valioso para balance y movimiento de azúcares.',
      nPlannerHintEs:
          'Corregir N tardío solo si la etapa todavía paga la intervención.',
      pPlannerHintEs:
          'Usar P tardío más como aprendizaje de plan que como corrección agresiva.',
      kPlannerHintEs:
          'Si K está corto, esta etapa sí puede justificar soporte del nutriente.',
      nConfidence01: 0.82,
      pConfidence01: 0.68,
      kConfidence01: 0.84,
    ),
    BeanStageKey.physiologicalMaturity: StageTargets(
      ...
      nShortGuidanceEs:
          'En cierre, N sirve más para lectura y aprendizaje del lote.',
      pShortGuidanceEs: 'En cierre, P ya no suele ser una urgencia operativa.',
      kShortGuidanceEs:
          'En cierre, K se interpreta más como balance final del lote.',
      nPlannerHintEs:
          'En madurez, preferir documentar y ajustar el siguiente plan antes que empujar correcciones tardías.',
      pPlannerHintEs:
          'Usar esta lectura para afinar el próximo arranque más que para corregir tarde.',
      kPlannerHintEs:
          'Usar esta lectura para balance y trazabilidad del plan próximo.',
      nConfidence01: 0.68,
      pConfidence01: 0.64,
      kConfidence01: 0.68,
    ),
    BeanStageKey.harvest: StageTargets(
      ...
      nShortGuidanceEs:
          'En cosecha, la lectura sirve más para cierre técnico que para intervención.',
      pShortGuidanceEs:
          'En cosecha, la lectura de P ayuda a afinar el siguiente ciclo.',
      kShortGuidanceEs:
          'En cosecha, la lectura de K ayuda a balance y trazabilidad del lote.',
      nPlannerHintEs: 'No empujar correcciones tardías de N en cosecha.',
      pPlannerHintEs:
          'Usar la lectura de P para preparar el siguiente arranque.',
      kPlannerHintEs:
          'Usar la lectura de K para ajustar el plan del siguiente ciclo.',
      nConfidence01: 0.62,
      pConfidence01: 0.60,
      kConfidence01: 0.62,
    ),

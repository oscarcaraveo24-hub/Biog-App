...
const WheatUniversalProfile wheatUniversalV1 = WheatUniversalProfile(
  byStage: {
    ...
    WheatStageKey.germination: StageTargets(
      ...
      nIndex: AgroRange(lowMax: 10, optimalMin: 20, optimalMax: 46, highMin: 63),
      pIndex: AgroRange(lowMax: 8, optimalMin: 18, optimalMax: 42, highMin: 58),
      kIndex: AgroRange(lowMax: 12, optimalMin: 26, optimalMax: 60, highMin: 76),
    ),
    ...
    WheatStageKey.vegEarly: StageTargets(
      ...
      ec: _wheatEcVeg,
      resistance: _wheatResistanceEarly,
      nIndex: AgroRange(lowMax: 10, optimalMin: 22, optimalMax: 48, highMin: 65),
      pIndex: AgroRange(lowMax: 8, optimalMin: 18, optimalMax: 42, highMin: 58),
      kIndex: AgroRange(lowMax: 12, optimalMin: 28, optimalMax: 62, highMin: 78),
    ),
    ...
    WheatStageKey.elongation: StageTargets(
      ...
      ec: _wheatEcVeg,
      resistance: _wheatResistanceEarly,
      nIndex: AgroRange(lowMax: 12, optimalMin: 24, optimalMax: 50, highMin: 66),
      pIndex: AgroRange(lowMax: 8, optimalMin: 18, optimalMax: 42, highMin: 58),
      kIndex: AgroRange(lowMax: 14, optimalMin: 30, optimalMax: 64, highMin: 80),
    ),

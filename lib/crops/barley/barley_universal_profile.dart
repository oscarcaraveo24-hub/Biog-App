...
const BarleyUniversalProfile barleyUniversalV1 = BarleyUniversalProfile(
  byStage: {
    ...
    BarleyStageKey.germination: StageTargets(
      ...
      nIndex: AgroRange(lowMax: 10, optimalMin: 20, optimalMax: 44, highMin: 62),
    ...
    BarleyStageKey.vegEarly: StageTargets(
      ...
      ec: _barleyEcVeg,
      resistance: _barleyResistanceEarly,
      nIndex: AgroRange(lowMax: 10, optimalMin: 22, optimalMax: 46, highMin: 64),
      pIndex: AgroRange(lowMax: 8, optimalMin: 18, optimalMax: 40, highMin: 56),
      kIndex: AgroRange(lowMax: 12, optimalMin: 28, optimalMax: 60, highMin: 76),
    ),

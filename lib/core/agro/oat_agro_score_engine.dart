...
class OatAgroScoreEngine {
  /// Etapas críticas para avena: embuche, espigamiento y floración.
  static const Set<OatStageKey> _criticalStages = {
    OatStageKey.booting,
    OatStageKey.heading,
    OatStageKey.flowering,
  };

  /// Semi-crítica: llenado.
  static const Set<OatStageKey> _semiCriticalStages = {OatStageKey.grainFill};

  static ({AgroEvalResult eval, AlertsState nextAlertsState}) evaluate({
    required BioGTelemetry t,
    required OatStageResult stage,
    required OatUniversalProfile u,

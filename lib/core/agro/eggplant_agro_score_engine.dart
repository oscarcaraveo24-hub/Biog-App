...
class EggplantAgroScoreEngine {
  static const Set<EggplantStageKey> _criticalStages = {
    EggplantStageKey.floracion,
    EggplantStageKey.cuajado,
  };

  static const Set<EggplantStageKey> _semiCriticalStages = {
    EggplantStageKey.llenado,
    EggplantStageKey.cosechaProgresiva,
  };

  static ({AgroEvalResult eval, AlertsState nextAlertsState}) evaluate({
    required BioGTelemetry t,
    required EggplantStageResult stage,
    required EggplantUniversalProfile u,
    ...
    final nMetric = _interpretEggplantNutrient(
    ...
    final pMetric = _interpretEggplantNutrient(
    ...
    final kMetric = _interpretEggplantNutrient(
    ...
    if (resEval.band == AgroBand.critical) criticalPenalty *= 0.84;
  ...
  static AgroMetricEval _interpretEggplantNutrient({
    required AgroMetricKey metricKey,
    required double rawMgKg,
    required bool hasData,
    required EggplantStageKey stageKey,
  ...
  static void _pushEnvironmentalAlerts(
    ...
    final qualitySensitive = stage.profile.visualQualitySensitive;
    ...
    } else if (airHum > (qualitySensitive ? 80 : 85)) {
  ...
  static String _stageLabelEs(EggplantStageKey stageKey) {
    switch (stageKey) {

...
class ChiliAgroScoreEngine {
  static const Set<ChiliStageKey> _criticalStages = {
    ChiliStageKey.floracion,
    ChiliStageKey.cuajado,
  };

  static const Set<ChiliStageKey> _semiCriticalStages = {
    ChiliStageKey.llenado,
    ChiliStageKey.cosechaProgresiva,
  };

  static ({AgroEvalResult eval, AlertsState nextAlertsState}) evaluate({
    required BioGTelemetry t,
    required ChiliStageResult stage,
    required ChiliUniversalProfile u,
    ...
    final nMetric = _interpretChiliNutrient(
    ...
    final pMetric = _interpretChiliNutrient(
    ...
    final kMetric = _interpretChiliNutrient(
  ...
  static AgroMetricEval _interpretChiliNutrient({
    required AgroMetricKey metricKey,
    required double rawMgKg,
    required ChiliStageKey stageKey,
  ...
  static String _stageLabelEs(ChiliStageKey stageKey) {
    switch (stageKey) {

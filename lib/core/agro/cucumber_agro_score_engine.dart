...
///
/// Mismo contrato que TomatoAgroScoreEngine: devuelve un AgroEvalResult con la
/// condición física del suelo (`soilControlScore01` + cobertura) y alertas.
/// N/P/K viajan como señal nativa sin diagnóstico (NPK Interpretation Reset,
/// Guía v0.4 §4); el manejo nutricional lo decide el motor de nutrición.
///

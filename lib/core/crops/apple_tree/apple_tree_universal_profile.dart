...
class AppleTreeUniversalProfile {
  ...
  /// pH objetivo universal de manzano: preferido 6.0-6.8; 5.5-7.5 es
  /// aceptable/vigilancia y el extremo fuerte queda cerca de <5.0 o >8.0.
...
/// Tabla maestra cableada desde documentos 02/05. Llave = TreeStageIds.
///
/// En suelo, `lowMax` y `highMin` son umbrales de extremo real; el rango
/// operativo documental vive entre `optimalMin` y `optimalMax`.
...
_appleStageProfiles = <String, _AppleStageProfile>{
  TreeStageIds.plantingTransplant: _AppleStageProfile(
    ...
    ec: AgroRange(lowMax: 0.0, optimalMin: 0.0, optimalMax: 1.5, highMin: 3.0),
  ...
  TreeStageIds.juvenileVegetative: _AppleStageProfile(
    ...
    ec: AgroRange(lowMax: 0.0, optimalMin: 0.0, optimalMax: 1.7, highMin: 3.0),
    resistance: AgroRange(
      lowMax: 0.0,
      optimalMin: 0.0,
      optimalMax: 1.7,
  ...
  TreeStageIds.dormancy: _AppleStageProfile(
    ...
    soilTemp: AgroRange(lowMax: -2, optimalMin: 4, optimalMax: 16, highMin: 35),
    ec: AgroRange(lowMax: 0.0, optimalMin: 0.0, optimalMax: 1.8, highMin: 3.0),
    resistance: AgroRange(
      lowMax: 0.0,
      optimalMin: 0.0,
      optimalMax: 2.0,
  ...
  TreeStageIds.budbreak: _AppleStageProfile(
    ...
    ec: AgroRange(lowMax: 0.0, optimalMin: 0.0, optimalMax: 1.6, highMin: 3.0),
    resistance: AgroRange(
      lowMax: 0.0,
      optimalMin: 0.0,
      optimalMax: 1.7,

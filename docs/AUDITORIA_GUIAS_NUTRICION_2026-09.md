...
- Frutales (decisión de producto, 7 sep): la dosis sale del **plan anual de huerta en producción** de cada guía (kg/ha de N, P₂O₅, K₂O) × fracción de la ventana, no de la cosecha esperada por árbol. Planes y fuentes: manzano 100–140 / 40–60 / 40–80 (UACH Chihuahua: fertirriego óptimo 138-45-40 a 64 t/ha; WSU Tree Fruit), peral 60–110 / 30–60 / 60–120 (WSU, UC ANR), durazno 100–160 / 30–60 / 100–160 (UC ANR), nogal pecanero 100–150 / 40–80 / 60–120 (SciELO 2020, Jiménez, Chihuahua; Intagri), pistache 120–200 / 40–70 / 120–200 (CDFA-FREP, UC ANR), naranjo y limonero 100–180 / 20–60 / 100–200 (Fitotecnia Mexicana, Veracruz; Intagri), mango 60–120 / 25–60 / 40–120 (INIFAP Nayarit), aguacate 150–250 / 60–120 / 150–300 (INIFAP Michoacán y Nayarit). Tres juegos de ventanas: hueso/pepita (N 65 % brotación / 35 % post-cosecha; K 30/70; P post-cosecha), nuez (N 45/40/15 brotación/llenado/post-cosecha; K 30/70; P en brotación) y perennifolio (N 50/20/30; K 30/50/20; P post-cosecha). El establecimiento lleva la mitad del P anual y queda fuera de la suma del ciclo de carga. Todo `proposed`, a confirmar con el socio agrónomo.
...
7. **Frutales.** Confirmar los planes anuales en kg/ha y las fracciones de `seasonShare` de `_pomeStoneTreeRules`, `_nutTreeRules` y `_evergreenTreeRules` (suman 1.0 por nutriente en el ciclo de carga). Los planes son de huerta adulta a rendimiento medio; huertas jóvenes o de bajo rendimiento van al mínimo o menos.
8. **Redacción de `timingEs` / `rationaleEs` (7 sep).** Los 141 textos de cuándo y porqué se reescribieron para el agricultor (`tools/guide_copy_pass.py`): frases completas, «nitrógeno / fósforo / potasio» con todas sus letras (nunca N/P/K sueltas), «lb N/acre» convertidas a kg/ha (lechuga 3–4 lb/acre/día → 3–4.5 kg/ha/día; cebolla 1.5–3.5 → 1.5–4 kg/ha/día) y códigos de etapa explicados («de 6 a 8 hojas (V6–V8)»). La agronomía es la misma; una prueba (`npk_tab_copy_test.dart`) impide que vuelvan letras sueltas o unidades extranjeras. Al auditar cada guía, revisar también la redacción.
